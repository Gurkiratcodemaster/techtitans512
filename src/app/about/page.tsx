        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">AI-Powered Guidance</h3>
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Skill Assessment</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Industry Insights</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Learning Resources</h3>
              <p className="text-gray-600">
