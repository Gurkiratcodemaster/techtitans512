    ...
    <div>
      ...
      <div className="mt-4 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-12">
          {/* Career Quiz Card */}
          <div className={"bg-white border border-gray-400  rounded-3xl p-8 text-center cursor-pointer hover:scale-[1.02] transition-transform duration-300"}>
            ...
            <div className="space-y-3">
              <Link href="/quiz/class10" className={`bg-blue-500 rounded-2xl text-white block w-full py-1 text-center hover:scale-105 `}>
                Class 10 Assessment
              </Link>
              <Link href="/quiz/class12" className={`bg-blue-500 rounded-2xl text-white block w-full py-1 text-center hover:scale-105 `}>
                Class 12 Assessment
              </Link>
            </div>
          </div>
          ...
          {/* AI Chatbot Card */}
          <div
            className={"bg-white border border-gray-400  rounded-3xl  p-8 text-center cursor-pointer hover:scale-[1.02] transition-transform duration-300"}
          ...
          >
            ...
            <button
              ...
              className={`bg-blue-500 rounded-2xl py-1 text-white w-full hover:scale-105 `}
            >
              Start Conversation
            </button>
          </div>
          ...
          <div className={"bg-white border border-gray-400  rounded-3xl p-8 text-center cursor-pointer hover:scale-[1.02] transition-transform duration-300"}>
            ...
            <Link
              ...
              className={`bg-blue-500 rounded-2xl py-1 text-white block w-full text-center hover:scale-105 `}
            >
              Explore Resources
            </Link>
          </div>
        ...
        <div className={" p-8 bg-white border border-gray-400  rounded-3xl mb-12 hover:scale-[1.02] transition-transform duration-300"}>
        ...
        <div className={"bg-white border border-gray-400  rounded-3xl p-6 mb-8 hover:scale-[1.02] transition-transform duration-300"}>
          <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={"p-8 bg-white border border-gray-400  rounded-3xl mb-12 text-center hover:scale-[1.02] transition-transform duration-300"}>
