          ...
          {showResults && results ? (
            ...
            >
              <div className="text-center mb-8">
                <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6 hover:scale-110 hover:rotate-[10deg] transition-transform duration-300">
              ...
              <div className="text-center space-x-4">
                <button
                  onClick={restartQuiz}
                  className={COLORS.primary.gradient + " " + COLORS.primary.gradientHover + " " + RESPONSIVE.button + " hover:scale-105"}
                >
                  Retake Quiz
                </button>
                <Link href="/career-paths">
                  <span className={COLORS.primary.gradient + " " + COLORS.primary.gradientHover + " " + RESPONSIVE.button + " inline-block hover:scale-105"}>
                  ...
                  <div className="space-y-4">
                    {questions[currentQuestion]?.options?.map((option, index) => (
                      <button
                        ...
                        className={`w-full p-4 text-left bg-white/50 hover:bg-white/80 rounded-2xl transition-all duration-300 border border-gray-200 hover:border-blue-300 hover:shadow-md hover:-translate-y-0.5 hover:scale-[1.01] ${
